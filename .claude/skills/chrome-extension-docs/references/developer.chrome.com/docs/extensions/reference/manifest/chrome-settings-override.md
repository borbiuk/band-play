...
Here is an example of how [homepage](#homepage), [search provider](#search_provider), and [startup pages](#startup_pages) can be modified
in the [extension manifest](/docs/extensions/mv3/manifest). Any domain used in the settings API must be [verified](https://support.google.com/webmasters/answer/35179) (via
