...
- `3`: Use the [Manifest V3](/docs/extensions/mv3/intro/mv3-overview) format and associated feature set.
      The current version is Manifest V3. The Chrome Web Store no longer accepts manifest V2 extensions
      (see [Manifest V2 support timeline](/docs/extensions/mv3/mv2-sunset) for more details). There will be other manifest
