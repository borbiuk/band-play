...
- ␣ Space — Play/Pause
- ⬅️ ➡️ Arrow Left/Right — Seek backward/forward
- ⬆️ ⬇️ Arrow Up/Down — Speed up/down (3.03%)
- ⇧ + ⬇️ — Reset speed
- 🇳 / 🇧 — Next / Previous track
- 0–9 — Jump to 0%, 10%, … 90% of track
- 🇴 — Open current track in a new tab; ⇧ + 🇴 — Open and focus
- 🇱 — Add/Remove from wishlist
- 🔗 Full list: https://github.com/borbiuk/band-play/blob/master/README.md#-keyboard-shortcuts

🔒 Privacy

- No data collection. No analytics. No external servers.
- All settings are stored locally via Chrome Storage.
- Open source: https://github.com/borbiuk/band-play
...
- 🐛 Report issues or request features: https://github.com/borbiuk/band-play/issues
