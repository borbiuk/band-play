	...
	return (
		...
		>
			<div className="relative flex items-center">
				<input
					type="checkbox"
					className="before:content[''] peer relative h-5 w-5 cursor-pointer appearance-none rounded-full border border-gray-900/20 bg-gray-900/10 transition-all duration-300 before:absolute before:left-2/4 before:top-2/4 before:block before:h-12 before:w-12 before:-translate-x-2/4 before:-translate-y-2/4 before:rounded-full before:bg-band-500 before:opacity-0 before:transition-opacity checked:border-b-band-700 checked:bg-band-700 checked:before:bg-band-700 hover:scale-115 hover:before:opacity-0"
					id={id}
					checked={isChecked}
