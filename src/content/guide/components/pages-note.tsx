...
export const PagesNote = () => {
	return (
		<div className="flex flex-row justify-around gap-x-2 rounded-xl bg-band-200/75 py-2 text-sm font-medium text-gray-800 shadow-md shadow-gray-400 duration-300 hover:scale-101 hover:shadow-xl">
